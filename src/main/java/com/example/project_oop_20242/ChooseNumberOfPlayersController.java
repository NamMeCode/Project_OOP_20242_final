    ...
    private void startGame(int playerCount) {
        try {
            ...
            switch (MenuController.gameID) {
                ...
                default -> throw new IllegalArgumentException("Invalid gameID: " + MenuController.gameID);
            }
            ...
            controller.setUpGame(playerCount, gameType, ChooseGameplayController.playWithBots,SettingsController.isTextMode);
